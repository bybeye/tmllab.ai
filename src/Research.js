		...
		<div class="col-md-3 col-12" style={{paddingBottom:"50px"}}>
		    <div class="row">
			    <div class="col-md-12 col-5">
   				<Link to="/Research" class="btn btn-outline-primary rounded-pill active">Publications</Link><br/><br/>
			    </div>
			    <div class="col-md-12 col-5">
